...
<p align="center"> <a href="#demo">🎮 플레이 영상</a> • <a href="#features">✨ 주요 특징</a> • <a href="#tech-stack">🧰 기술 스택</a> • <a href="#setup">⚙️ 설치/실행</a> • <a href="#screenshots">🖼️ 스크린샷</a> </p> <p> <img alt="Unity" src="https://img.shields.io/badge/Unity-2022.3_LTS-black?logo=unity"/> <img alt="Render Pipeline" src="https://img.shields.io/badge/Render%20Pipeline-URP-informational"/> <img alt="Platform" src="https://img.shields.io/badge/Platform-Windows%20%7C%20macOS-blue"/> </p>
TL;DR
...
플레이 루프: 달린다 → 장애물 회피 → 코인 수집(점수) → 체크포인트로 시간 연장 → 더 어려워지는 스폰 속도에 적응
